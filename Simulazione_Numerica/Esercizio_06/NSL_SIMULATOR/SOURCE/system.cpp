    ...
    if (_sim_type == 2) {
      while ( !input.eof() ){
        ...
        if( (property == "TOTAL_ENERGY") and (_H == 0.0) ){
          ofstream coutt_2("../OUTPUT/PLOT/total_energy_MTR.dat");
          coutt_2 << "#     BLOCK:   ACTUAL_TE:    TE_AVE:      ERROR:" << endl;
          coutt_2.close();
        } else if( (property == "MAGNETIZATION") and (_H > 0.0) ){
          ofstream coutpr_2("../OUTPUT/PLOT/magnetization_MTR.dat");
          coutpr_2 << "#     BLOCK:   ACTUAL_M:     M_AVE:       ERROR:" << endl;
          coutpr_2.close();
        } else if( (property == "SPECIFIC_HEAT") and (_H == 0.0) ){
          ofstream coutpr_2("../OUTPUT/PLOT/specific_heat_MTR.dat");
          coutpr_2 << "#     BLOCK:   ACTUAL_CV:    CV_AVE:      ERROR:" << endl;
          coutpr_2.close();
        } else if( (property == "SUSCEPTIBILITY") and (_H == 0.0) ){
          ofstream coutpr_2("../OUTPUT/PLOT/susceptibility_MTR.dat");
      ...
      input >> property;
      if( (property == "TOTAL_ENERGY") and (_H == 0.0) ){
        ofstream coutt_2("../OUTPUT/PLOT/total_energy_GIBBS.dat");
        coutt_2 << "#     BLOCK:   ACTUAL_TE:    TE_AVE:      ERROR:" << endl;
        coutt_2.close();
      } else if((property == "MAGNETIZATION") and (_H > 0.0)){
        ofstream coutpr_2("../OUTPUT/PLOT/magnetization_GIBBS.dat");
        coutpr_2 << "#     BLOCK:   ACTUAL_M:     M_AVE:       ERROR:" << endl;
        coutpr_2.close();
      } else if( (property == "SPECIFIC_HEAT") and (_H == 0.0) ){
        ofstream coutpr_2("../OUTPUT/PLOT/specific_heat_GIBBS.dat");
        coutpr_2 << "#     BLOCK:   ACTUAL_CV:    CV_AVE:      ERROR:" << endl;
        coutpr_2.close();
      } else if( (property == "SUSCEPTIBILITY") and (_H == 0.0) ){
        ofstream coutpr_2("../OUTPUT/PLOT/susceptibility_GIBBS.dat");
        coutpr_2 << "#     BLOCK:   ACTUAL_X:     X_AVE:       ERROR:" << endl;
        coutpr_2.close();
        }
      }
...
void System :: averages_plot(int blk, int temp_step){
  ...
  if (_sim_type == 2) {
    ...
    if (_measure_cv){
      ...
      _global_av(_index_cv)  += _average(_index_cv);
      _global_av2(_index_cv) += _average(_index_cv) * _average(_index_cv); // % -> element-wise multiplication
      coutf.open("../OUTPUT/PLOT/specific_heat_MTR.dat",ios::app);
      average  = _average(_index_cv);
      sum_average = _global_av(_index_cv);
      sum_ave2 = _global_av2(_index_cv);
  ...
  if (_sim_type == 3) {
    ...
    if (_measure_cv){
      ...
      _global_av(_index_cv)  += _average(_index_cv);
      _global_av2(_index_cv) += _average(_index_cv) * _average(_index_cv); // % -> element-wise multiplication
      coutf.open("../OUTPUT/PLOT/specific_heat_GIBBS.dat",ios::app);
      average  = _average(_index_cv);
      sum_average = _global_av(_index_cv);
      sum_ave2 = _global_av2(_index_cv);
      coutf << setw(12) << temp_step
  ...
  if (_sim_type == 2) {
    // TOTAL ENERGY //////////////////////////////////////////////////////////////
    if (_measure_tenergy){
      coutf.open("../OUTPUT/PLOT/total_energy_MTR.dat",ios::app);
      average  = _average(_index_tenergy);
      sum_average = _global_av(_index_tenergy);
      sum_ave2 = _global_av2(_index_tenergy);
      coutf << setw(12) << temp_step
    ...
    // MAGNETIZATION /////////////////////////////////////////////////////////////
    if (_measure_magnet){
      coutf.open("../OUTPUT/PLOT/magnetization_MTR.dat",ios::app);
      average  = _average(_index_magnet);
      sum_average = _global_av(_index_magnet);
      sum_ave2 = _global_av2(_index_magnet);
      coutf << setw(12) << temp_step
    ...
    // SUSCEPTIBILITY ////////////////////////////////////////////////////////////
    if (_measure_chi){
      coutf.open("../OUTPUT/PLOT/susceptibility_MTR.dat",ios::app);
      average  = _average(_index_chi);
      sum_average = _global_av(_index_chi);
      sum_ave2 = _global_av2(_index_chi);
      coutf << setw(12) << temp_step
    ...
    // TOTAL ENERGY //////////////////////////////////////////////////////////////
    if (_measure_tenergy){
      coutf.open("../OUTPUT/PLOT/total_energy_GIBBS.dat",ios::app);
      average  = _average(_index_tenergy);
      sum_average = _global_av(_index_tenergy);
      sum_ave2 = _global_av2(_index_tenergy);
      coutf << setw(12) << temp_step
    ...
    // MAGNETIZATION /////////////////////////////////////////////////////////////
    if (_measure_magnet){
      coutf.open("../OUTPUT/PLOT/magnetization_GIBBS.dat",ios::app);
      average  = _average(_index_magnet);
      sum_average = _global_av(_index_magnet);
      sum_ave2 = _global_av2(_index_magnet);
      coutf << setw(12) << temp_step
    ...
    // SUSCEPTIBILITY ////////////////////////////////////////////////////////////
    if (_measure_chi){
      coutf.open("../OUTPUT/PLOT/susceptibility_GIBBS.dat",ios::app);
      average  = _average(_index_chi);
      sum_average = _global_av(_index_chi);
      sum_ave2 = _global_av2(_index_chi);
      coutf << setw(12) << temp_step
